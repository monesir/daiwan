            ...
            if (!window.aldiwanHideAIFn) {
                window.aldiwanHideAIFn = () => {
                    ...
                    document.querySelectorAll('.gradient-diwan').forEach(el => {
                        ...
                        if (h3) {
                            h3.textContent = 'اللَّهُمَّ صَلِّ وسلم وبارك عَلَى محمد وَعَلَى آلِ محمد كَمَا صَلَّيْتَ وبَارَكْتَ عَلَى إِبْرَاهِيمَ وعَلَى آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ';
